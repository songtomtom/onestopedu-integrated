(function() {
   ...
   */
  ListNoticeController.$inject = ['$scope', '$filter', 'Notice'];

  /**
   * Configuring the Notice list controller
   */
  function ListNoticeController($scope, $filter, Notice) {
     ...
     */
    function figureOut() {
      vm.filteredItems = $filter('filter')(vm.notices, vm.search);
