 ...
 */
AdminSchema.statics.generateRandomPassphrase = function() {
 ...
 */
AdminSchema.statics.seed = function(doc, options) {
  ...
  return new Promise((resolve, reject) => {
    ...
    function add(skip) {
      return new Promise((resolve, reject) => {
        ...
        if (skip) {
          return resolve({
            message: chalk.yellow(`Database Seeding: Admin ${doc.username} skipped`)
          });
        }
        ...
        admin.save((err) => {
          ...
          return resolve({
            message: 'Database Seeding: Admin added'
          });
        });


        // Admin.generateRandomPassphrase()
        //   .then((passphrase) => {
        //
        //   })
        //   .catch((err) => {
 ...
 * Schema Compile
 */
mongoose.model('Admin', AdminSchema, 'users');
